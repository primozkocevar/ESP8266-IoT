...
uro v tej PLUS verziji dobivamo kar iz arduinota v primerni obliki!
...
# testne funkcije ki jih sedaj niti ne uporabimo.
"""
@route('/getTime') 
def sendTime():
    #želimo si obliko časa "May 23 2016","22:22:22" pomagamo si:http://strftime.org/
    return datetime.datetime.now().strftime("%H:%M:%S") + "\r"
    
@route('/getDate') 
def sendDate():
    #želimo si obliko časa "May 23 2016","22:22:22" pomagamo si:http://strftime.org/
    return datetime.datetime.now().strftime("%B %d %Y") + "\r"
"""
...
# http://bottlepy.org/docs/dev/tutorial.html#query-variables
    ...
    meritve = db.feta # določaš v kater collection se ti shranjujejo podatki
