...
# ta del pošilja čas in deluje kot lastni NTP server, za katerega ne rabiš interneta.
@route('/getDatetime') 
def sendDatetime():
    # hočemo obliko POSIX za pošiljanje nazaj!
    return str(time.time()) + "\r"
...
# http://bottlepy.org/docs/dev/tutorial.html#query-variables
    ...
    meritve = db.pubDev1 # določaš v kater collection se ti shranjujejo podatki
